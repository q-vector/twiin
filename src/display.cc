...
Display::Display (const string& orog_3_file_path,
                  ...
                  const std::map<Nwp_Element, string>& model_file_path_3_map,
                  const std::map<Nwp_Element, string>& model_file_path_4_map,
                  const std::map<Nwp_Element, string>& model_file_path_5_map)
